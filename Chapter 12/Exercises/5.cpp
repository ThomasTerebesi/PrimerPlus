...
int main()
{
	...
	std::cout << "Objective: Find out the maximum number of customers per hour that leads to" << std::endl;
	std::cout << "an average wait time of approximately one minute." << std::endl;
